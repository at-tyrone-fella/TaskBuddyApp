 ...
 * @param {Array<Object>} data - The array of data to be exported to Excel.
 * @param {string} fileName - The name of the file to be saved (without extension).
 * @returns {Promise<string|null>} - The URI of the saved file or null if there was an error.
 */
 ...
 * @returns {Promise<void>} - Resolves when the share action completes or fails.
 */
